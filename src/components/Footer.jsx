    ...
    <footer className="w-full bg-gray-900 text-white mt-16 py-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          ...
          <ul className="text-gray-400 space-y-2">
            ...
            <li className="hover:text-white transition-colors">
              <a href="/#sell-your-car-button" className="flex items-center">
                <span className="w-1 h-1 bg-gray-400 rounded-full mr-2"></span>
                Sell Your Car
              </a>
            </li>
        ...
        >
          ...
          <p className="text-gray-400 mb-2">Email: support@carplatform.com</p>
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 mt-8 border-t border-gray-800">
        <p className="text-gray-500 text-sm text-center">
          &copy; {new Date().getFullYear()} Car Platform. All rights reserved.
        </p>
      </div>
    </footer>
  );
